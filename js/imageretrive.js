...
storageRef.child('product_display/menswatch/first/').listAll().then(function(result){
...
function displayImage(row,images){
  images.getDownloadURL().then(function(url){
    ...
    document.getElementById('imags').innerHTML+=`<a href="${url}" target="_blank">
    <img id="retrivedimg" width="300" height="300" style="margin-left:20px; margin-top:20px" src="${url}" class="img-fluid">
    </a>`;
  });
}
document.getElementById('f1').innerHTML+=` <p style="float: right;">Sony</p>`;
    ...
    document.getElementById('f7').innerHTML+=`<p style="float: right;">Rs. 40,000/-</p>`;
});
...
storageRef.child('product_display/third').listAll().then(function(result){
  result.items.forEach(function(imageRef){
      console.log(imageRef.toString());
...
storageRef.child('product_display/fourth').listAll().then(function(result){
  result.items.forEach(function(imageRef){
      console.log(imageRef.toString());
...
storageRef.child('product_display/fifth').listAll().then(function(result){
  result.items.forEach(function(imageRef){
      console.log(imageRef.toString());
...
storageRef.child('product_display/sixth').listAll().then(function(result){
  result.items.forEach(function(imageRef){
      console.log(imageRef.toString());
...
storageRef.child('product_display/seventh').listAll().then(function(result){
  result.items.forEach(function(imageRef){
      console.log(imageRef.toString());
...
storageRef.child('product_display/eighth').listAll().then(function(result){
  result.items.forEach(function(imageRef){
      console.log(imageRef.toString());
